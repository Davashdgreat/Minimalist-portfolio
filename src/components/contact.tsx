      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
        ...
        >
          ...
          <div className="flex justify-center space-x-6 animate-bounce">
            ...
            >
              <FaGithub
                size={32}
                className="text-gray-900 hover:text-gray-400 dark:text-gray-100"
              />
            </a>
            <a
        ...
        >
          ...
          <form ref={formRef} onSubmit={sendEmail} className="space-y-3 md:space-y-4">
            ...
            <button
              type="submit"
              className="w-full border bg-transparent text-white py-3 rounded-lg hover:bg-gray-500 hover:text-white hover:border-black cursor-pointer"
            >
              Send Message
            </button>
            {message && (
